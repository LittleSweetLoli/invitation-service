...
### Почему?
- В качестве драйвера используется pq, старый проверенный драйвер, очень прост в использовании и полностью совместим с database/sql.
- Роутер chi - потому что легкий, быстрый и понятный

### Что бы я добавил в Production
